        ...
        switch (nlcn_msg.proc_ev.what) {
            ...
            case PROC_EVENT_UID: {
                if (nlcn_msg.proc_ev.event_data.id.process_pid !=
                    ...
                    break;
                printf("event=uid process.pid=%d uid.from=%d uid.to=%d\n",
            ...
            case PROC_EVENT_GID: {
                if (nlcn_msg.proc_ev.event_data.id.process_pid !=
                    nlcn_msg.proc_ev.event_data.id.process_tgid)
                    break;
                printf("event=gid process.pid=%d gid.from=%d gid.to=%d\n",
                nlcn_msg.proc_ev.event_data.id.process_pid,
            ...
            case PROC_EVENT_EXIT: {
                if (nlcn_msg.proc_ev.event_data.exit.process_pid != 
                    ...
                    break;
                printf("event=exit process.pid=%d exit.code=%d\n",
